...
namespace StarWarsApp
{
    class StarWarsStarshipsAdapter : BaseAdapter<StarshipsDetails>
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            view.FindViewById<TextView>(Resource.Id.textViewStarships5).Text = "Length: " + item.Length;
            view.FindViewById<TextView>(Resource.Id.textViewStarships6).Text = "Cargo Space: " + item.Cargo_Capacity;
            view.FindViewById<TextView>(Resource.Id.textViewStarships7).Text = "Consumables: " + item.Consumables;
            view.FindViewById<TextView>(Resource.Id.textViewStarships8).Text = "Crew: " + item.Crew;
            view.FindViewById<TextView>(Resource.Id.textViewStarships9).Text = "Passengers: " + item.Passengers;
            ...
            view.FindViewById<TextView>(Resource.Id.textViewStarships12).Text = "Mglt: " + item.Mglt;
